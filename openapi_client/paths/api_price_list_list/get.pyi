...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PriceListModelsPriceList']:
            return PriceListModelsPriceList

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PriceListModelsPriceList'], typing.List['PriceListModelsPriceList']],
    ...
    def __getitem__(self, i: int) -> 'PriceListModelsPriceList':
...
class ListPriceLists(BaseApi):
    ...
    def list_price_lists(
        ...
        return self._list_price_lists_oapg(
