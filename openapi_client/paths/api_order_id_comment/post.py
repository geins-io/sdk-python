...
# body param
SchemaForRequestBodyApplicationJson = APIOrderOrderComment
SchemaForRequestBodyTextJson = APIOrderOrderComment
SchemaForRequestBodyApplicationXml = APIOrderOrderComment
SchemaForRequestBodyTextXml = APIOrderOrderComment
SchemaForRequestBodyApplicationXWwwFormUrlencoded = APIOrderOrderComment


request_body_order_comment = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_comment_to_order_oapg(
        self,
    ...
    def _add_comment_to_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_order_comment.serialize(body, content_type)
...
class AddCommentToOrder(BaseApi):
    ...
    def add_comment_to_order(
        ...
        return self._add_comment_to_order_oapg(
            body=body,
