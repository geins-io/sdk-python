...
# body param
SchemaForRequestBodyApplicationJson = UserModelsWriteUserProfile
SchemaForRequestBodyTextJson = UserModelsWriteUserProfile
SchemaForRequestBodyApplicationXml = UserModelsWriteUserProfile
SchemaForRequestBodyTextXml = UserModelsWriteUserProfile
SchemaForRequestBodyApplicationXWwwFormUrlencoded = UserModelsWriteUserProfile


request_body_user_profile = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeUserModelsReadUserProfile
SchemaFor200ResponseBodyTextJson = EnvelopeUserModelsReadUserProfile
SchemaFor200ResponseBodyApplicationXml = EnvelopeUserModelsReadUserProfile
SchemaFor200ResponseBodyTextXml = EnvelopeUserModelsReadUserProfile
...
class BaseApi(api_client.Api):
    ...
    def _update_user_profile_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_profile.serialize(body, content_type)
...
class UpdateUserProfile(BaseApi):
    ...
    def update_user_profile(
        ...
        return self._update_user_profile_oapg(
            body=body,
