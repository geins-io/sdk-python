...
# body param
SchemaForRequestBodyApplicationJson = ShippingModelsShippingQuery
SchemaForRequestBodyTextJson = ShippingModelsShippingQuery
SchemaForRequestBodyApplicationXml = ShippingModelsShippingQuery
SchemaForRequestBodyTextXml = ShippingModelsShippingQuery
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShippingModelsShippingQuery


request_body_shipping_query = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ShippingModelsShippingOption']:
            return ShippingModelsShippingOption

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ShippingModelsShippingOption'], typing.List['ShippingModelsShippingOption']],
    ...
    def __getitem__(self, i: int) -> 'ShippingModelsShippingOption':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_shipping_options_oapg(
        self,
    ...
    def _query_shipping_options_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_shipping_query.serialize(body, content_type)
...
class QueryShippingOptions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def query_shipping_options(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def query_shipping_options(
        ...
        return self._query_shipping_options_oapg(
            body=body,
