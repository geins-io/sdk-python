...
# body param
SchemaForRequestBodyApplicationJson = BrandModelsWriteBrand
SchemaForRequestBodyTextJson = BrandModelsWriteBrand
SchemaForRequestBodyApplicationXml = BrandModelsWriteBrand
SchemaForRequestBodyTextXml = BrandModelsWriteBrand
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BrandModelsWriteBrand
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeBrandModelsReadBrand
SchemaFor200ResponseBodyTextJson = EnvelopeBrandModelsReadBrand
SchemaFor200ResponseBodyApplicationXml = EnvelopeBrandModelsReadBrand
SchemaFor200ResponseBodyTextXml = EnvelopeBrandModelsReadBrand
...
class UpdateBrand(BaseApi):
    ...
    def update_brand(
        ...
        return self._update_brand_oapg(
            body=body,
