...
# body param
SchemaForRequestBodyApplicationJson = ProductParameterModelsWriteProductParameterPredefinedValue
SchemaForRequestBodyTextJson = ProductParameterModelsWriteProductParameterPredefinedValue
SchemaForRequestBodyApplicationXml = ProductParameterModelsWriteProductParameterPredefinedValue
SchemaForRequestBodyTextXml = ProductParameterModelsWriteProductParameterPredefinedValue
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ProductParameterModelsWriteProductParameterPredefinedValue


request_body_product_parameter_predefined_value = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeProductParameterModelsReadProductParameterPredefinedValue
SchemaFor200ResponseBodyTextJson = EnvelopeProductParameterModelsReadProductParameterPredefinedValue
SchemaFor200ResponseBodyApplicationXml = EnvelopeProductParameterModelsReadProductParameterPredefinedValue
SchemaFor200ResponseBodyTextXml = EnvelopeProductParameterModelsReadProductParameterPredefinedValue
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_product_parameter_predefined_value_oapg(
        self,
    ...
    def _create_product_parameter_predefined_value_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_parameter_predefined_value.serialize(body, content_type)
...
class CreateProductParameterPredefinedValue(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_product_parameter_predefined_value(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_product_parameter_predefined_value(
        ...
        return self._create_product_parameter_predefined_value_oapg(
            body=body,
