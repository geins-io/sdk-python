...
# body param
SchemaForRequestBodyApplicationJson = SupplierModelsWriteSupplier
SchemaForRequestBodyTextJson = SupplierModelsWriteSupplier
SchemaForRequestBodyApplicationXml = SupplierModelsWriteSupplier
SchemaForRequestBodyTextXml = SupplierModelsWriteSupplier
SchemaForRequestBodyApplicationXWwwFormUrlencoded = SupplierModelsWriteSupplier


request_body_supplier = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeSupplierModelsReadSupplier
SchemaFor200ResponseBodyTextJson = EnvelopeSupplierModelsReadSupplier
SchemaFor200ResponseBodyApplicationXml = EnvelopeSupplierModelsReadSupplier
SchemaFor200ResponseBodyTextXml = EnvelopeSupplierModelsReadSupplier
...
class BaseApi(api_client.Api):
    ...
    def _update_supplier_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_supplier.serialize(body, content_type)
...
class UpdateSupplier(BaseApi):
    ...
    def update_supplier(
        ...
        return self._update_supplier_oapg(
            body=body,
