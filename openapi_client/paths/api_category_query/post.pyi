...
# body param
SchemaForRequestBodyApplicationJson = CategoryModelsCategoryQuery
SchemaForRequestBodyTextJson = CategoryModelsCategoryQuery
SchemaForRequestBodyApplicationXml = CategoryModelsCategoryQuery
SchemaForRequestBodyTextXml = CategoryModelsCategoryQuery
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CategoryModelsCategoryQuery
...
class QueryCategories(BaseApi):
    ...
    def query_categories(
        ...
        return self._query_categories_oapg(
            body=body,
