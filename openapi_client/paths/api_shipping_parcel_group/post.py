...
# body param
SchemaForRequestBodyApplicationJson = ShippingModelsParcelGroupOptions
SchemaForRequestBodyTextJson = ShippingModelsParcelGroupOptions
SchemaForRequestBodyApplicationXml = ShippingModelsParcelGroupOptions
SchemaForRequestBodyTextXml = ShippingModelsParcelGroupOptions
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShippingModelsParcelGroupOptions


request_body_parcel_group_options = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeInt
SchemaFor200ResponseBodyTextJson = EnvelopeInt
SchemaFor200ResponseBodyApplicationXml = EnvelopeInt
SchemaFor200ResponseBodyTextXml = EnvelopeInt
...
class BaseApi(api_client.Api):
    ...
    def _create_parcel_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_parcel_group_options.serialize(body, content_type)
...
class CreateParcelGroup(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_parcel_group(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_parcel_group(
        ...
        return self._create_parcel_group_oapg(
            body=body,
