...
# body param
SchemaForRequestBodyApplicationJson = ProductParameterModelsWriteProductParameter
SchemaForRequestBodyTextJson = ProductParameterModelsWriteProductParameter
SchemaForRequestBodyApplicationXml = ProductParameterModelsWriteProductParameter
SchemaForRequestBodyTextXml = ProductParameterModelsWriteProductParameter
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ProductParameterModelsWriteProductParameter


request_body_product_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EnvelopeProductParameterModelsReadProductParameter
SchemaFor200ResponseBodyTextJson = EnvelopeProductParameterModelsReadProductParameter
SchemaFor200ResponseBodyApplicationXml = EnvelopeProductParameterModelsReadProductParameter
SchemaFor200ResponseBodyTextXml = EnvelopeProductParameterModelsReadProductParameter
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_product_parameter_oapg(
        self,
    ...
    def _update_product_parameter_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_parameter.serialize(body, content_type)
...
class UpdateProductParameter(BaseApi):
    ...
    def update_product_parameter(
        ...
        return self._update_product_parameter_oapg(
            body=body,
