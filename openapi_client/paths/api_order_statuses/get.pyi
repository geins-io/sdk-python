...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['OrderModelsOrderStatus']:
            return OrderModelsOrderStatus

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['OrderModelsOrderStatus'], typing.List['OrderModelsOrderStatus']],
    ...
    def __getitem__(self, i: int) -> 'OrderModelsOrderStatus':
...
class GetOrderStatuses(BaseApi):
    ...
    def get_order_statuses(
        ...
        return self._get_order_statuses_oapg(
