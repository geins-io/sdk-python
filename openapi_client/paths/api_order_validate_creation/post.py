...
# body param
SchemaForRequestBodyApplicationJson = OrderValidateOrderCreationRequest
SchemaForRequestBodyTextJson = OrderValidateOrderCreationRequest
SchemaForRequestBodyApplicationXml = OrderValidateOrderCreationRequest
SchemaForRequestBodyTextXml = OrderValidateOrderCreationRequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = OrderValidateOrderCreationRequest
...
class ValidateOrder(BaseApi):
    ...
    def validate_order(
        ...
        return self._validate_order_oapg(
            body=body,
