...
# body param
SchemaForRequestBodyApplicationJson = PaymentModelsPaymentOptionQuery
SchemaForRequestBodyTextJson = PaymentModelsPaymentOptionQuery
SchemaForRequestBodyApplicationXml = PaymentModelsPaymentOptionQuery
SchemaForRequestBodyTextXml = PaymentModelsPaymentOptionQuery
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PaymentModelsPaymentOptionQuery
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['PaymentModelsPaymentOption']:
            return PaymentModelsPaymentOption

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['PaymentModelsPaymentOption'], typing.List['PaymentModelsPaymentOption']],
    ...
    def __getitem__(self, i: int) -> 'PaymentModelsPaymentOption':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_payment_options_oapg(
        self,
...
class QueryPaymentOptions(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def query_payment_options(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def query_payment_options(
        ...
        return self._query_payment_options_oapg(
            body=body,
