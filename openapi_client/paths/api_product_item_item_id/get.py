...
SchemaFor200ResponseBodyApplicationJson = ProductProductItemEnvelope
SchemaFor200ResponseBodyTextJson = ProductProductItemEnvelope
SchemaFor200ResponseBodyApplicationXml = ProductProductItemEnvelope
SchemaFor200ResponseBodyTextXml = ProductProductItemEnvelope
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_product_item_by_id_oapg(
        self,
...
class GetProductItemById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_product_item_by_id(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_product_item_by_id(
        ...
        return self._get_product_item_by_id_oapg(
