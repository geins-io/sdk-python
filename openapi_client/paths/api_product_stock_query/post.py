...
request_body_product_item_ids = api_client.RequestBody(
    content={
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ProductModelsReadProductItemStock']:
            return ProductModelsReadProductItemStock

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ProductModelsReadProductItemStock'], typing.List['ProductModelsReadProductItemStock']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'ProductModelsReadProductItemStock':
        return super().__getitem__(i)
...
class BaseApi(api_client.Api):
    ...
    def _query_stock_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_item_ids.serialize(body, content_type)
