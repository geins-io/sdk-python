...
request_body_product_item_stocks = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProductModelsStockEnvelope
SchemaFor200ResponseBodyTextJson = ProductModelsStockEnvelope
SchemaFor200ResponseBodyApplicationXml = ProductModelsStockEnvelope
SchemaFor200ResponseBodyTextXml = ProductModelsStockEnvelope
...
class BaseApi(api_client.Api):
    @typing.overload
    def _batch_update_stock_values_oapg(
        self,
    ...
    def _batch_update_stock_values_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_product_item_stocks.serialize(body, content_type)
...
class BatchUpdateStockValues(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def batch_update_stock_values(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        query_params: RequestQueryParams = frozendict.frozendict(),
    ...
    def batch_update_stock_values(
        ...
        return self._batch_update_stock_values_oapg(
            body=body,
