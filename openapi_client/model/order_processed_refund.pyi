...
class OrderProcessedRefund(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["RefundId", "ExternalId", "Reference", "ProcessedOn", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["RefundId", "ExternalId", "Reference", "ProcessedOn", ], str]):
