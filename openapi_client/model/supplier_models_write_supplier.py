...
class SupplierModelsWriteSupplier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Name", "Address1", "Address2", "Address3", "ZipCode", "Country", "ContactPerson", "Phone1", "Phone2", "Email", "ExternalId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Name", "Address1", "Address2", "Address3", "ZipCode", "Country", "ContactPerson", "Phone1", "Phone2", "Email", "ExternalId", ], str]):
