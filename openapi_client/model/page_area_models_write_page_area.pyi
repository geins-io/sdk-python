...
class PageAreaModelsWritePageArea(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Settings() -> typing.Type['SystemNullableValidationConfiguration']:
                return SystemNullableValidationConfiguration
            __annotations__ = {
                "Index": Index,
                "Name": Name,
                "FamilyId": FamilyId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Settings"]) -> 'SystemNullableValidationConfiguration': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Index", "Name", "FamilyId", "Settings", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Settings"]) -> typing.Union['SystemNullableValidationConfiguration', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Index", "Name", "FamilyId", "Settings", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Settings: typing.Union['SystemNullableValidationConfiguration', schemas.Unset] = schemas.unset,
