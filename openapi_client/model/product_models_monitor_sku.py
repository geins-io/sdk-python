...
class ProductModelsMonitorSku(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SkuId"]) -> MetaOapg.properties.SkuId: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["SiteId", "LanguageCode", "Email", "SkuId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SkuId"]) -> typing.Union[MetaOapg.properties.SkuId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["SiteId", "LanguageCode", "Email", "SkuId", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        SkuId: typing.Union[MetaOapg.properties.SkuId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
