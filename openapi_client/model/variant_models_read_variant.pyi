...
class VariantModelsReadVariant(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProductId", "GroupId", "Label", "Value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProductId", "GroupId", "Label", "Value", ], str]):
