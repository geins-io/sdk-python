...
class PageWidgetLazyLoadSetupLazyLoadCollectionConfiguration(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CollectionName", "EnableLazyloadMobile", "EagerLoadStepsMobile", "EnableLazyloadDesktop", "EagerLoadStepsDesktop", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CollectionName", "EnableLazyloadMobile", "EagerLoadStepsMobile", "EnableLazyloadDesktop", "EagerLoadStepsDesktop", ], str]):
