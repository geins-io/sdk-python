...
class APIOrderTransactionData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["OrderId", "TransactionId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["OrderId", "TransactionId", ], str]):
