...
class ProductParameterModelsWriteProductParameterValue(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProductId", "ParameterId", "Value", "LocalizedDescriptions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProductId", "ParameterId", "Value", "LocalizedDescriptions", ], str]):
