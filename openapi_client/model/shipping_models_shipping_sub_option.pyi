...
class ShippingModelsShippingSubOption(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Id", "ExternalId", "Name", "Fee", "Logo", "ShippingData", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Id", "ExternalId", "Name", "Fee", "Logo", "ShippingData", ], str]):
