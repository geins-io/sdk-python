...
class BrandModelsReadBrand(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["BrandId", "Name", "ExternalId", "Descriptions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["BrandId", "Name", "ExternalId", "Descriptions", ], str]):
