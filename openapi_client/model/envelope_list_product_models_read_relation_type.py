...
class EnvelopeListProductModelsReadRelationType(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class Resource(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProductModelsReadRelationType']:
                        return ProductModelsReadRelationType
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ProductModelsReadRelationType'], typing.List['ProductModelsReadRelationType']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'Resource':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ProductModelsReadRelationType':
                    return super().__getitem__(i)
