        ...
        class properties:
            ...
            class Resource(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProductModelsReadFeed']:
                        return ProductModelsReadFeed
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ProductModelsReadFeed'], typing.List['ProductModelsReadFeed']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'Resource':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ProductModelsReadFeed':
                    return super().__getitem__(i)
