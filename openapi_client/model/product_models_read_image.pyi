...
class ProductModelsReadImage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProductId", "Url", "Order", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProductId", "Url", "Order", ], str]):
