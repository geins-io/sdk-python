...
class UserModelsUserProfileQuery(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["UserId", "Email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["UserId", "Email", ], str]):
