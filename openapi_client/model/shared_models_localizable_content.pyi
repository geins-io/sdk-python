...
class SharedModelsLocalizableContent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["LanguageCode", "Content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["LanguageCode", "Content", ], str]):
