# openapi_client.model.envelope.Envelope
...
**[Resource](#Resource)** | dict, frozendict.frozendict,  | frozendict.frozendict,  | The resource on which the action was taken. | [optional] 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | The resource on which the action was taken. | 
