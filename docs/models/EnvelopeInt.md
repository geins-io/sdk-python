# openapi_client.model.envelope_int.EnvelopeInt
...
**Resource** | decimal.Decimal, int,  | decimal.Decimal,  | The resource on which the action was taken. | [optional] value must be a 32 bit integer
