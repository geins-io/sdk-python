...
class TestPageWidgetLazyLoadSetupLazyLoadCollectionConfiguration(unittest.TestCase):
    """PageWidgetLazyLoadSetupLazyLoadCollectionConfiguration unit test stubs"""
